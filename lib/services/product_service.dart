...
class ProductService {
  ...
  final List<Product> _allProducts = [
    ...
    const Product(
      ...
      title: 'Lanyard',
      price: 3.50,
      imageUrl: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&h=1000&fit=crop',
      collectionId: 'accessories',
      colors: ['Navy', 'Red'],
    ),
    const Product(
    ...
    const Product(
      ...
      price: 19.99,
      imageUrl: 'https://images.unsplash.com/photo-1530325553241-4f6e7690cf36?w=800&h=1000&fit=crop',
      collectionId: 'gifts',
    ),
    const Product(
      id: '26',
    ...
    const Product(
      ...
      price: 11.99,
      imageUrl: 'https://images.unsplash.com/photo-1603006905003-be475563bc59?w=800&h=1000&fit=crop',
      collectionId: 'gifts',
      colors: ['White'],
    ),
